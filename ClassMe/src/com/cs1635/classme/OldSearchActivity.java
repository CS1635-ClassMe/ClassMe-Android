...
public class OldSearchActivity extends ActionBarActivity implements SearchView.OnQueryTextListener
{
	long lastSearch;
	SupportMenuItem refresh;
	OldSearchActivity context = this;
	ListView postList;
	String searchString;
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		...
		if (searchView != null)
		{
			...
			searchView.setQueryHint("SearchActivity for posts");
